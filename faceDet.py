'''
Note - You will need to find your own directory for the cascade .xml files.
When you do, just comment out line 18 & 19, copy those lines with your own file path to the .xml files.
...
while True:
    ...
    for (x, y, w, h) in faces: # To draw rectangle for face
        ...
        for (ex,ey,ew,eh) in eyes: # To draw rectangle for eyes
    ...
    if cv2.waitKey(1) & X+Y > 400: # Once the rectangle for the face is big enough, end the recording.
